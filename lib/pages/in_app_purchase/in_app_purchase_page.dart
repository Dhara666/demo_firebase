import 'package:demofirebase/pages/in_app_purchase/subscribe_screen.dart';
...
class InAppPurchasePageState extends State<InAppPurchasePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('MOKSHA PREMIUM',
  ...
  Future<void> clearIOSTransactions() async {
    ...
    for (final transaction in transactions) {
      ...
      if (transaction.transactionState !=
          SKPaymentTransactionStateWrapper.failed || transaction.transactionState !=
          SKPaymentTransactionStateWrapper.purchasing ||
